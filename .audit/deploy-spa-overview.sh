...
# keep canopy + check devices
echo "$PW" | sudo -S docker exec dsc-hub-mosquitto mosquitto_pub -h 127.0.0.1 -t zigbee2mqtt/qa_canopy -m '{"temperature":27.5,"humidity":58.0}'
