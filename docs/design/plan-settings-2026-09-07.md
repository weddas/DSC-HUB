...
- **2026-09-07 — merged to master** tip `6ddd7c8` / commit `2196e28`: S1–S3 + S7 cameras core + composed twin + SPA prod-bundle fix. Developer SoT: [`docs/brain/SETTINGS.md`](../brain/SETTINGS.md) · [`docs/cameras.md`](../cameras.md) · [`docs/brain/TWIN.md`](../brain/TWIN.md) · [`docs/ops/SPA-PROD-BUNDLE.md`](../ops/SPA-PROD-BUNDLE.md). Hub firmware flash for Brain Stage Targets remains an operator step on kit hubs that predate the switch.
- Next: Pass S5 (device drawers), then S4 (system/transparency). S7b (plant regions) waits on S6 media.
