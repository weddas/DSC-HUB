...
| Waves 2–5 (CannaLib, PPFD, Twin, polish) | **done (code)** | Tip `28953ae` / spa `15d7016`; SoT OPERATOR-POLISH · VIZ-ECHARTS · CANNALIB-API; live CannaLib CDN offset still deferred |
