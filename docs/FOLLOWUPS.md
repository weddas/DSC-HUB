...
| Pre-rebuild Climate Mode A + DSC-Probe | **next-plan** | Interrogate 2026-08-29: do **not** put full stages on `clone_mode`; Pi owns Follow Plants; probe/plant/assignment split — plan `docs/superpowers/plans/2026-08-29-pre-rebuild-interrogate.md` · design SoT [`CLIMATE-MODE-POLICY`](brain/CLIMATE-MODE-POLICY.md) · [`PROBE-PLANT-MODEL`](brain/PROBE-PLANT-MODEL.md) · [`SOFT-CAL`](ops/SOFT-CAL.md) |
