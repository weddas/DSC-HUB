...
- [`docs/qa/PI-APPLIANCE-7.0.md`](qa/PI-APPLIANCE-7.0.md) — hub.controls + control proxy fan/light/select + useFleetEntity (tip SHA `c1a451a`)
...
3. Prefer this tip’s docs PR over #92 for tip SoT; close/supersede #89–#92 after review if overlapping.
