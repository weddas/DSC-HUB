...
| Pass 4 Twin-first | **Phase A code** | Tasks 1-3 on tip `ca106d7` (hybrid Got + DutyStrip Twin). B/C/gate open. GPIO5 reserved. SoT: `docs/brain/LIVE-UX-HONESTY.md` / `docs/ops/TWIN-SF1000.md` |
...
## 2026-09-01 - Live UX Pass 4 Twin-first (Phase A code)
...
**Walk:** [`docs/qa/LIVE-UX-PASS4-WALK-2026-09.md`](qa/LIVE-UX-PASS4-WALK-2026-09.md) - Phase A code landed; prove pending
**Developer runbook:** [`docs/brain/LIVE-UX-HONESTY.md`](brain/LIVE-UX-HONESTY.md) / [`docs/ops/TWIN-SF1000.md`](ops/TWIN-SF1000.md) (tip `ca106d7` / spa `index-BEjnawnp.js`)
...
| Phase A hybrid Got + Twin on ingest | **code** (`b4ca126`) | `got_source` twin/window; pytest `test_live_ux_pass4_twin.py` |
| Phase A Light Twin + DutyStrip Actual | **code** (`5144978`) | spa `index-BEjnawnp.js` |
| Task 4 Pi smoke / Phase B walk | **not started** | Findings table empty |
