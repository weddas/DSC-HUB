...
| Pre-rebuild Climate Mode A + DSC-Probe | **in progress** | Entity rename + cal_session + OTA; cleanup `docs/qa/PROBE-RENAME-CLEANUP.md`. Spec: `docs/superpowers/specs/2026-08-29-climate-mode-probe-rebuild-design.md` |
