...
| Pre-rebuild Climate Mode A + DSC-Probe | **in progress** | Code on master (`654d0f8`). OTA blocked 2026-08-29: Pi ESPHome DNS fail fetching PlatformIO espressif32 from GitHub — need Pi internet or USB/prebuilt. Runbook: `docs/ops/ESPHOME-OTA-PI.md` · cleanup: `docs/qa/PROBE-RENAME-CLEANUP.md` |
