...
| Tip SoT runbook on master | **landing** | `docs/brain/SPACE-ENERGY-JOURNAL.md` + `PHOTOPERIOD-TIMELINE.md` for tip `78a8397` (supersedes draft doc PRs #159–#164 tip-hash drift) |
