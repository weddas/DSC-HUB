...
| Bar3 + IrrigAct developer SoT | **done (docs)** | `docs/brain/ROOT-STEERING.md` — P0–P3 + `irrigact.py` shot path (tip `bce7ca9`) |
| SoftCal + SoftCal AI SoT | **done (docs)** | `docs/ops/SOFT-CAL.md` — Raw offsets + `/ai/soft-cal-advice`; sessions API still unwired in SPA |
| Twin SF1000 SoT | **done (docs)** | `docs/ops/TWIN-SF1000.md` — GPIO5 entity vs clone dimmer |
