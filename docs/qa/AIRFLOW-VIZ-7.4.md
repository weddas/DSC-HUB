...
**Status:** Scaffold **landed** (still on tip `39d7f88`) — `AirflowParticleViz` + lazy `AirflowParticleScene` on Climate “Air path”. Trim panel / full particle field / CFD hints still incomplete (Phase D2).  
