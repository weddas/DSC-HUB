...
**Git:** `7fa85b5` on `origin/master` · Pi SPA `index-Ciw7XTuZ.js` (+ `calibrate-CzxOXAJy` · `tune-fleet-KoWKiPmD`) — HelpTip / OOS / ESP·Modbus shipped; live hot-patch after C:→Y: sync  
