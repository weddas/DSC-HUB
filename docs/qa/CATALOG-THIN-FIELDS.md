...
**Updated:** 2026-08-10 (post densify + SF end-link + unresolved promote harden).  
...
| P3 | `lineage_unresolved` | **~8.7k** after junk + promote harden | No exact match / UI garbage rejected | Alias when bases appear; re-quarantine chrome; **no fuzzy** |
...
- Promoting UI chrome / long marketing sentences into `strain_canonical`
