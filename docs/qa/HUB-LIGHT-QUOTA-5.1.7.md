...
Supersedes draft runbook naming for **5.1.6-only** flash paths — flash **5.1.7**.
...
2. [ ] Validate + flash hub stub → FW **5.1.7** (not 5.1.6)
3. [ ] Serial (or log) shows `Ledger rev1 seed` on first photoperiod tick after upgrade
4. [ ] Entities present: Delivered / Debt / Catch-up / Min Dark Hours
5. [ ] If flashed **during dark**: Delivered ≈ plan, Debt ≈ 0, catch-up **idle**
...
| Scenario | Expect |
|---|---|
| Fresh flash mid-dark (5.1.7) | Seed marks day paid; SF1000 stays off; no invented debt |
| Fresh flash mid-window | Seed credits elapsed; no full-day debt; continues crediting |
...
| Re-flash 5.1.7 after rev already 1 | No re-seed; normal credit / rollover / carry |
...
| ID | Item |
|---|---|
| N-030 | Flash hub **5.1.7** + sync HA light helpers / Lighting view |
| F-006 | HA-link flap / recovery reboot storm (upstream driver) |

Sibling draft docs (#19–#25) cover other subsystems — keep this file focused
on light quota, photoperiod survival, and first-ledger seed.
