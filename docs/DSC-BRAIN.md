...
| [`docs/brain/`](brain/) | Specs: decision loop, web UI, Zigbee Role/Task, Pi appliance path |
| [`docs/brain/ZIGBEE-ROLE-TASK.md`](brain/ZIGBEE-ROLE-TASK.md) | Settings Zigbee Role vs Task + liquid polarity (tip `c224eba`) |
