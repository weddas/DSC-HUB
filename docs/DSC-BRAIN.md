...
| [`docs/brain/`](brain/) | Specs: decision loop, SPA/CI, computed cache, sensor trust |
| [`docs/ops/CANNALIB-API.md`](ops/CANNALIB-API.md) | CannaLib client wiring + Pi sqlite fallback honesty |
