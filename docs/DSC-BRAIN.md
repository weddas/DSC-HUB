...
| [`docs/brain/`](brain/) | Specs: decision loop, kit SPA, Climate Mode, web UI, Pi appliance path |
| [`docs/ops/FLEET-SOIL-METRICS.md`](ops/FLEET-SOIL-METRICS.md) | NPK / dryback / moisture-rate producers + SPA map |
