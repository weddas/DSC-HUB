...
| [`docs/brain/`](brain/) | Specs: decision loop, web UI, Pi appliance path, kit setup, climate plausibility |
| [`docs/ops/USB-FLASH.md`](ops/USB-FLASH.md) | Baked-binary USB flash guards (vs ESPHome OTA) |
