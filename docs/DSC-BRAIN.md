...
Relay entity honesty (device-observed vs commanded vs demand): [`docs/ops/RELAY-HONESTY.md`](ops/RELAY-HONESTY.md). Dashboard desks + zone roles: [`docs/brain/WEBUI.md`](brain/WEBUI.md) · [`docs/brain/ZONE-MODEL.md`](brain/ZONE-MODEL.md).
