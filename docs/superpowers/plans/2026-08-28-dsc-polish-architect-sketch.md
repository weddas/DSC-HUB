...
| SPA `HelpTip` | Desk map + HubLinkLine Up/Down/Beat honesty + ZoneFocus (**done** tip `c1eaedd`) — [`docs/brain/HELP-TIP.md`](../../brain/HELP-TIP.md); Mission demoted tips optional; **SPA rebuild** still required |
