...
| SPA `HelpTip` | Desk map + HubLinkLine Up/Down/`HS`·`HB #` + ZoneFocus + OOS rail + ESP/Modbus chips (**done** tip `a50d402`, spa-dist shipped) — [`docs/brain/HELP-TIP.md`](../../brain/HELP-TIP.md) |
