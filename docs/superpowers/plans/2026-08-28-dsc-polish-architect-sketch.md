...
| SPA `HelpTip` | Desk map + HubLinkLine Up/Down/`HS`·`HB #` + ZoneFocus + honesty rail (**done** tip `8fc5e33`) — [`docs/brain/HELP-TIP.md`](../../brain/HELP-TIP.md); **SPA rebuild** still required |
