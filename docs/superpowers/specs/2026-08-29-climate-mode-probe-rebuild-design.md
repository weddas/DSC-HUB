...
**Date:** 2026-08-29  
**Status:** **approved** — Climate Mode + SoftCal Raw (`9343be6`); probe rename / `cal_session` / SoftCal history (`654d0f8`); Pi ESPHome DNS pin + Control ESPHome 2025.12 OTA path + pot3/4 kit retirement (`18849da`); compose `DSC_POT*_API_KEY` casing (`19b5c4b`); ops closed on FOLLOWUPS (`05e8471`). Live OTA: hub + pot1 + pot2 + control @ 7.0.0.0. Ops: `docs/brain/CLIMATE-MODE-POLICY.md`, `PROBE-PLANT-MODEL.md`, `docs/ops/SOFT-CAL.md`, `ESPHOME-OTA-PI.md`.  
