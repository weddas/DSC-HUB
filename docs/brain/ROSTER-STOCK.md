...
**Tip (Mega Pass 2026-09):** `a307dc7` · SPA bundle `index-DlMHgtYz.js` (+ `calibrate-BaYkAZKZ.js` · `tune-fleet-BiYmPtFc.js` · `twin-three-BjdbWAdH.js`)  
...
**Code:** `compose_store.ROSTER_SLOT_COUNT` · `compose_ops.assign_to_pot` / `retire_roster_slot` · `plant_probe.release_conflicting_slot_pots` · `api.POST /roster/slots/{n}/retire` · SPA `PlantWizard` · `GrowPages` (`vacantProbes`, `confirmRetire`) · `seatModel.buildPlantSeat` · `useBrain.refreshComputed` · `fleetApi.get_fleet_computed` · `ui.flushEntityTextDrafts` · `composePlantLogic.clearComposeDraft` · `brain/tests/test_roster_stress.py`  
...
**Trail:** [`../FOLLOWUPS.md`](../FOLLOWUPS.md) § *2026-09-01 — Mega Pass 2026-09* · § *Post-stress audit* · [`../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md`](../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md) · [`../ops/PI-HOTPATCH.md`](../ops/PI-HOTPATCH.md)  
