...
**Tip (roster computed refresh after retire):** `149657d` · SPA `index-DsUt6Y4m.js`  
**Prior (capacity + stock + slot retire):** `15d7016` · Bar 2: `fe55e4e`  
**Code:** `brain/dsc_brain/plant_probe.py` · `compose_ops.py` · `compose_store.py` · `api.py` · SPA `fleetApi.ts` · `useBrain.tsx` · `GrowPages.tsx` · `PlantSeatPanel.tsx`  
