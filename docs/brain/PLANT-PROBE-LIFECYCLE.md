...
**Prior Mega Pass 2026-09:** `a307dc7` · `index-DlMHgtYz.js`  
...
**Code:** `brain/dsc_brain/plant_probe.py` · `compose_ops.py` · `compose_store.py` · `api.py` · SPA `fleetApi.ts` · `useBrain.tsx` · `GrowPages.tsx` · `components/roster/RosterLifecycleDialogs.tsx` · `seatModel.ts` · `PlantSeatPanel.tsx` · `brain/tests/test_roster_stress.py`  
**Rules:** [`.cursor/rules/dsc-roster-probe.mdc`](../../.cursor/rules/dsc-roster-probe.mdc) · [`.cursor/rules/dsc-kit-sot.mdc`](../../.cursor/rules/dsc-kit-sot.mdc)  
**Plan / trail:** [`../superpowers/plans/2026-08-29-plant-probe-lifecycle.md`](../superpowers/plans/2026-08-29-plant-probe-lifecycle.md) · tip SoT [ROSTER-STOCK.md](ROSTER-STOCK.md) · [KIT-SCOPE.md](KIT-SCOPE.md) · [SPA-MODULE-MAP.md](SPA-MODULE-MAP.md) · Mega Pass register [`../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md`](../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md)  
...
| Object | Meaning | SoT |
|--------|---------|-----|
| **Probe** | Hardware soil stick + inventory seat `potN` / entities `dsc_probeN_*` | Kit Probe **1–2** live; 3–4 Advanced restore only ([KIT-SCOPE.md](KIT-SCOPE.md)) |
...
| **Assign** | Binds detached/unassigned/stock slot onto a vacant probe; `release_conflicting_slot_pots` clears stale claims; compose `assign_to_pot` also writes **slot `sprout`** from recipe | Silently overwrite another plant’s true occupancy (400) |
...
| `#/grow/roster` | Detach · Assign · **Delete** (slot retire; drawer close uses captured `retirePot`); vacant strip excludes roster-claimed probes |
| Crop scheduler | Stock/detached lanes on tent rail — [ROSTER-STOCK.md](ROSTER-STOCK.md) |
| Plant seat drawer | Detach · Move · Retire; sprout/days/stage from pot helpers with roster fallback ([ROSTER-STOCK.md](ROSTER-STOCK.md) § Sprout) |
