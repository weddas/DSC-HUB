...
**Tip (Mega Pass 2026-09):** `a307dc7` · SPA `index-DlMHgtYz.js`  
...
**Code:** `brain/dsc_brain/plant_probe.py` · `compose_ops.py` · `compose_store.py` · `api.py` · SPA `fleetApi.ts` · `useBrain.tsx` · `GrowPages.tsx` · `seatModel.ts` · `PlantSeatPanel.tsx` · `brain/tests/test_roster_stress.py`  
**Rules:** [`.cursor/rules/dsc-roster-probe.mdc`](../../.cursor/rules/dsc-roster-probe.mdc)  
**Plan / trail:** [`../superpowers/plans/2026-08-29-plant-probe-lifecycle.md`](../superpowers/plans/2026-08-29-plant-probe-lifecycle.md) · tip SoT [ROSTER-STOCK.md](ROSTER-STOCK.md) · Mega Pass register [`../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md`](../qa/MEGA-PASS-2026-09-ISSUE-REGISTER.md)  
