...
Verified tip: `9343be6` / `516a6b3` (+ probe rename train `654d0f8`) against `climate_mode.py`, `follow_plants.py`, `control_ops.apply_clone_tent_automation`, hub `apply_clone_mode`, panel 0xD1 v2.
...
- Probe entity ids are now `dsc_probeN_*` in tree (`654d0f8`); live boards need the OTA train — see [`ESPHOME-OTA-PI.md`](../ops/ESPHOME-OTA-PI.md).
