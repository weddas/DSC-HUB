...
**Tip (Post-mega D-C-A-B):** `f029702` · spa-dist `index-CXq-NptO.js` (+ `calibrate-qZfij39E.js` · `tune-fleet-DYnNNyOJ.js` · `twin-three-BjdbWAdH.js`)  
...
npm run build:spa
# verify spa-dist/index.html → assets/index-CXq-NptO.js
```

Windows lab deploy: [`../ops/PI-HOTPATCH.md`](../ops/PI-HOTPATCH.md). Tip expects **`index-CXq-NptO.js`**.
