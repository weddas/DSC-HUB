...
Code: [`brain/dsc_brain/automation_rules.py`](../../brain/dsc_brain/automation_rules.py). SPA editor: Settings › Automation (`#/settings/automation`) + Alerts desk rules table (`AutomationRulesCard`).
...
- Settings › Automation: full editor (compound triggers, targets from `/settings/automations/targets`).
