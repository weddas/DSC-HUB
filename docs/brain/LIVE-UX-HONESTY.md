...
**Tip:** `b429179` · spa-dist `index-BEjnawnp.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js`)  
**Status:** Pass 1 Light **gate green** · Pass 2 Climate **gate green** · Pass 3 Overview **gate green**. Passes 1–3 program **closed**. **Pass 4 Twin-first Phase A GREEN** (Tasks 1–4: hybrid Got, Light Twin + DutyStrip, Pi smoke + brightness scale) — Phase B/C/full-stress gate **still open**; GPIO5 still **reserved** (not wired). Pass 5 remains stub after Pass 4 gate.
...
Pass 4 reports: [`.superpowers/sdd/pass4-task-2-report.md`](../../.superpowers/sdd/pass4-task-2-report.md) · [`.superpowers/sdd/pass4-task-3-report.md`](../../.superpowers/sdd/pass4-task-3-report.md) · [`.superpowers/sdd/pass4-task-4-report.md`](../../.superpowers/sdd/pass4-task-4-report.md) ·  
...
| 4 | Twin-first integrated | [`LIVE-UX-PASS4-WALK-2026-09.md`](../qa/LIVE-UX-PASS4-WALK-2026-09.md) (Phase A rows **pass**; B/C/gate pending) | `test_live_ux_pass4_twin.py` | **Phase A GREEN** on `b429179` — B/C/gate **open** |
| 5 | Follow-up | — | — | **stub** after Pass 4 gate |

Screenshots: `docs/qa-screenshots-2026-09-01-live-ux/`. Evidence: `.audit/live-ux-light-prove-evidence.json` · `.audit/live-ux-climate-prove-evidence.json` · `.audit/live-ux-overview-prove-evidence.json` · `.audit/live-ux-pass4-prove-evidence.json` (Phase A).
...
## Pass 4 — Twin-first integrated (Phase A GREEN; B/C/gate open)

**Do not invent Pass 4 gate green.** Tip `b429179` closed Phase A (Tasks 1–4): hybrid Got, Light Twin + DutyStrip, Pi smoke with filled A1–A8 walk rows, hub light brightness scale. Phase B re-walk, Phase C parks, and Task 7 full-stress gate remain open. Optical / GPIO5 wire-up is still deferred.
...
| Phase | Intent | Verified tip `b429179` | Still open |
|-------|--------|------------------------|------------|
...
| B | Inventory re-walk | Walk file present | Findings table empty (Task 5) |
...
- Pass 4 Phase A **GREEN** ≠ Pass 4 **gate green** — need Phase B/C + Task 7 full stress + FOLLOWUPS gate write-up.
