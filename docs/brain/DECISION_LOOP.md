...
Full honesty map (dual-home stations, pending_reassert, dash dual-emit cleanup, Root NPK/Rate `readingOk`, `got_*` history + fleet-map aliases, coldest-root trust skip): [`HONESTY.md`](HONESTY.md).
