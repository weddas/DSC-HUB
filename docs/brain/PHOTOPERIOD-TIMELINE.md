...
**Tip:** `a22050a` (spa-dist `index-DMMGdgxP.js`) · prior v7.4.0 light audit [`docs/qa/LIGHT-AUDIT-7.4-live.md`](../qa/LIGHT-AUDIT-7.4-live.md)
...
**Same tip (`a22050a`):** space model + `/energy/shift/plan` (`confirm=true`) is the approve-only slide path; plant card is journal-only. See [`SPACE-ENERGY-JOURNAL.md`](SPACE-ENERGY-JOURNAL.md).
