...
**Tip:** `42a4f92` / ship `a22050a` (spa-dist `index-DMMGdgxP.js`) · prior v7.4.0 light audit [`docs/qa/LIGHT-AUDIT-7.4-live.md`](../qa/LIGHT-AUDIT-7.4-live.md)
...
| Energy / journals (same tip) | [`SPACE-ENERGY-JOURNAL.md`](SPACE-ENERGY-JOURNAL.md) — LightEnergyPanel + TentOccupancyJournal below the clocks |
...
**Same tip:** space model + `/energy/shift/plan` (`confirm=true`) is the approve-only slide path; plant card is journal-only. See [`SPACE-ENERGY-JOURNAL.md`](SPACE-ENERGY-JOURNAL.md).

**Pi closure (next):** both tents get identical mutate + journal prove; room + DSC-Core journals are **not** Light-page surfaces — Ops/Dash per [closure design](../superpowers/specs/2026-09-01-space-energy-pi-closure-design.md).
...
- [`WEBUI.md`](WEBUI.md) · [`SPACE-ENERGY-JOURNAL.md`](SPACE-ENERGY-JOURNAL.md) · [`../qa/PLAN-7.4.md`](../qa/PLAN-7.4.md)
