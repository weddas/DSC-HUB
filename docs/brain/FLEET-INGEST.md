...
**Intent:** How Pi brain turns hub/panel/pot/Sonoff Native API traffic and Zigbee MQTT into fleet truth and Sonoff relays — including 7.1.1 closeout and the 7.1.2 heatmat alias fix. Verified against tip `ab49dd8`.
