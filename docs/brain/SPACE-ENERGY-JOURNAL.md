...
**Status:** **SHIPPED + Pi-proven** — plant/tent/room/DSC-Core journals, energy + shift APIs, Overview room/Core UI, both-tent force-tick walk. Specs marked **implemented**. Live UX honesty (Light + Climate gates green; Overview SPA Task 8 landed; Task 9 walk open) — see [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md).
