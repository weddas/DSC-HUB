...
**Status:** **SHIPPED + Pi-proven** — plant/tent/room/DSC-Core journals, energy + shift APIs, Overview room/Core UI, both-tent force-tick walk. Specs marked **implemented**. Live UX honesty program (Light + Climate desks green; Overview pytest landed) — see [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md).
