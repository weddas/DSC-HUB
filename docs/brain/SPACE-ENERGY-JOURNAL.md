...
**Status:** **SHIPPED + Pi-proven** — plant/tent/room/DSC-Core journals, energy + shift APIs, Overview room/Core UI, both-tent force-tick walk. Specs marked **implemented**. Live UX honesty Passes 1–3 **gate green**; Pass 4 Twin-first **Phase A GREEN** (hybrid Got / DutyStrip Twin / Pi smoke; B/C/gate open) — see [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md) · [`../ops/TWIN-SF1000.md`](../ops/TWIN-SF1000.md).
