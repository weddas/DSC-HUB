...
**Tip:** `2feb837` (spa-dist `index-DYFvyI2i.js` + `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js`; space-energy ship `78a8397`; Pass 1 Light desk-green `985a2c4`; Pass 2 climate pytest `2feb837`)  
**Status:** **SHIPPED + Pi-proven** — plant/tent/room/DSC-Core journals, energy + shift APIs, Overview room/Core UI, both-tent force-tick walk. Specs marked **implemented**. Live UX: [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md).
...
| Room journal | `#/live/overview` | `RoomJournal.tsx` (default `grow_room`) |
| DSC-Core journal | `#/live/overview` | `CoreJournal.tsx` |
