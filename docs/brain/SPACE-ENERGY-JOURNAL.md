...
**Tip:** `3d1ead4` (spa-dist `index-DYFvyI2i.js` + `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js`; space-energy ship `78a8397`, Pass 1 API + SPA honesty CTAs on tip)  
**Status:** **SHIPPED + Pi-proven** — plant/tent/room/DSC-Core journals, energy + shift APIs, Overview room/Core UI, both-tent force-tick walk. Specs marked **implemented**. Pass 1 Light honesty: [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md).
