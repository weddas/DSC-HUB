...
**Tip:** `b429179` · spa-dist `index-BEjnawnp.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js` · `twin-three-BjdbWAdH.js`)  
...
| `#/live/light` | Tent clocks, PhotoperiodTimeline, LightEnergyPanel, TentOccupancyJournal, Twin SF1000 toggle+brightness when available (Got hybrid + DutyStrip Twin Actual — Pass 4 Phase A; GPIO5 reserved) |
...
| Pass 4 Twin-first | **Phase A GREEN** (B/C/gate open) | Tip spa `index-BEjnawnp.js`; hybrid Got + DutyStrip Twin; Pi smoke A1–A8 pass; brightness 0–255↔0–1; pytest `test_live_ux_pass4_twin.py`; Task 7 gate pending — [`../ops/TWIN-SF1000.md`](../ops/TWIN-SF1000.md) |
