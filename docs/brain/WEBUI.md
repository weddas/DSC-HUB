...
**Tip:** `ca106d7` · spa-dist `index-BEjnawnp.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js` · `twin-three-BjdbWAdH.js`)  
...
| Pass 4 Twin-first | **Phase A code** (B/C/gate open) | Tip spa `index-BEjnawnp.js`; hybrid Got + DutyStrip Twin; pytest `test_live_ux_pass4_twin.py`; Pi smoke/gate pending — [`../ops/TWIN-SF1000.md`](../ops/TWIN-SF1000.md) |
