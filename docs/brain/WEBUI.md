...
**Tip:** `e7ebfd3` · spa-dist `index-C8GkS5XE.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js` · `twin-three-BjdbWAdH.js`)  
...
| `#/live/light` | Tent clocks, PhotoperiodTimeline, LightEnergyPanel, TentOccupancyJournal, Twin SF1000 chip/toggle when available (Got still window — Pass 4) |
...
| Pass 3 Overview | **green** (Task 8 SPA + Task 9 prove) | Tip spa `index-C8GkS5XE.js`; journals OOS/grow-log honesty; walk G0–G9 pass; `test_live_ux_overview_honesty.py` |
| Pass 4 Twin-first | **design+plan only** | Spec/plan on tip `e7ebfd3`; hybrid Got / walk / gate **not** started — [`../ops/TWIN-SF1000.md`](../ops/TWIN-SF1000.md) |
