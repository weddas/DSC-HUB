...
**Tip (Post-mega D-C-A-B):** `f029702` · spa-dist `index-CXq-NptO.js` (+ `calibrate-qZfij39E.js` · `tune-fleet-DYnNNyOJ.js` · `twin-three-BjdbWAdH.js`) · [SPA-MODULE-MAP.md](SPA-MODULE-MAP.md) · [KIT-SCOPE.md](KIT-SCOPE.md) · [ROSTER-STOCK.md](ROSTER-STOCK.md) · [PLANT-WIZARD.md](PLANT-WIZARD.md) · [PLANT-PROBE-LIFECYCLE.md](PLANT-PROBE-LIFECYCLE.md) · [R3F-CANVAS.md](R3F-CANVAS.md) · [ZIGBEE-POLICY-UI.md](ZIGBEE-POLICY-UI.md)  
...
Windows lab path: [`../ops/PI-HOTPATCH.md`](../ops/PI-HOTPATCH.md) (`pscp`/`plink`, not OpenSSH `scp`). Verify served `index.html` hash matches spa-dist (`index-CXq-NptO.js` on tip).
