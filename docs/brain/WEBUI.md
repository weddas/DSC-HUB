...
Grouped rail **You / The grow / The kit** — sections: Preferences · Alerts · Zones · Climate · Light · Root · Sensors · Automation · Devices · Integrations · Network · System. Search + anchors in `settingsIndex.ts`. Developer SoT: [`SETTINGS.md`](SETTINGS.md). Cameras UI: `#/settings/devices#cameras` ([`docs/cameras.md`](../cameras.md)).
...
| Doc | Topic |
|---|---|
| [SETTINGS.md](SETTINGS.md) | Settings S1–S3, hub tunables, prefs |
