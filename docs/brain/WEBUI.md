...
**Tip:** `3df3924` · spa-dist `index-C8GkS5XE.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js` · `twin-three-BjdbWAdH.js`)  
...
| Desk | Gate | Spa / tests |
|------|------|-------------|
| Pass 1 Light | **green** (walk filled) | Prove used `index-DYFvyI2i.js`; Climate live was `index-CzcL7cKc.js`; `test_live_ux_light_honesty.py` |
| Pass 2 Climate | **green** (walk filled) | Live prove spa `index-CzcL7cKc.js`; `test_live_ux_climate_honesty.py` |
| Pass 3 Overview | **SPA in repo** (Task 8) — Pi walk/prove Task 9 open | Tip spa `index-C8GkS5XE.js`; journals OOS/grow-log honesty; `test_live_ux_overview_honesty.py` |
