...
**Tip:** `2feb837` · spa-dist `index-DYFvyI2i.js` (+ `calibrate-DcOg5koY.js` · `tune-fleet-B5F45eEz.js` · `twin-three-BjdbWAdH.js`) · space-energy walk [`../qa/SPACE-ENERGY-PI-WALK-2026-09.md`](../qa/SPACE-ENERGY-PI-WALK-2026-09.md) · Live UX [`LIVE-UX-HONESTY.md`](LIVE-UX-HONESTY.md) (Pass 1 desk-green; Pass 2 climate pytest)
