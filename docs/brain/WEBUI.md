...
Kit model, Pass A–C, Root trust/stage: [`KIT-SOT-SPA.md`](KIT-SOT-SPA.md). Soil NPK / dryback / rate (incl. stations): [`../ops/FLEET-SOIL-METRICS.md`](../ops/FLEET-SOIL-METRICS.md). Stage calendar: [`PROBE-PLANT-MODEL.md`](PROBE-PLANT-MODEL.md). Design: [`../superpowers/specs/2026-08-29-professional-spa-ui-design.md`](../superpowers/specs/2026-08-29-professional-spa-ui-design.md).
