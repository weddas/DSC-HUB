...
| SPA bundle (spa-dist) | `index-DL1EcjhX` (+ `tune-fleet-IPnSFs3d` · `calibrate-D1D5CnxU`) — **source** tip has HelpTip / HS·HB Age / ZoneFocus / honesty rail; **rebuild spa-dist** before operators see it |
...
| Honesty rail | ≤6 chips + `+N`; held Got keeps numbers; CFM nameplate → Learning; CTAs avoid demoted Mission |
