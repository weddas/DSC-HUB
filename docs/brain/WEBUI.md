...
**Tip (Mega Pass 2026-09):** `a307dc7` · spa-dist `index-DlMHgtYz.js` (+ `calibrate-BaYkAZKZ.js` · `tune-fleet-BiYmPtFc.js` · `twin-three-BjdbWAdH.js`) · [ROSTER-STOCK.md](ROSTER-STOCK.md) · [PLANT-WIZARD.md](PLANT-WIZARD.md) · [PLANT-PROBE-LIFECYCLE.md](PLANT-PROBE-LIFECYCLE.md) · [R3F-CANVAS.md](R3F-CANVAS.md) · [ZIGBEE-POLICY-UI.md](ZIGBEE-POLICY-UI.md)  
...
| `#/grow/roster` | Plant roster — detach / assign / **slot Delete** (drawer close via captured `retirePot`); vacant strip vs roster claims |
| `#/grow/compose` | Plant Wizard — stock or seated create; preset label on review |
| `#/fleet/calibrate` | SoftCal / soil cal |
| `#/settings` | Inventory, Zigbee bind + live policy chips, advanced |
...
Windows lab path: [`../ops/PI-HOTPATCH.md`](../ops/PI-HOTPATCH.md) (`pscp`/`plink`, not OpenSSH `scp`). Verify served `index.html` hash matches spa-dist (`index-DlMHgtYz.js` on tip).
...
- Mega Pass closure: [`../qa/AUDIT-CLOSURE-2026-09.md`](../qa/AUDIT-CLOSURE-2026-09.md)
