...
**Tip:** `15d7016` (operator polish landed `28953ae` / HACS sync `94705f0`; roster tip supersedes spa-dist hashes) · **Progress:** [`.superpowers/sdd/progress-operator-polish.md`](../../.superpowers/sdd/progress-operator-polish.md) · **Wave 1:** [OPERATOR-WAVE1.md](OPERATOR-WAVE1.md) · **Viz:** [VIZ-ECHARTS.md](VIZ-ECHARTS.md)
...
- `FlowSankey`: air CFM provenance only (Allocated / Nameplate). Deprecated `heatTentW` / `heatMatW` props ignored.
...
| Calibrate | `calibrate-CadBxMGV.js` |
| Tune fleet | `tune-fleet-DouQtSz_.js` |
| Twin | `twin-three-B0t1gmm4.js` |

Live smoke (progress file): SoftCal_OK · live_hold · outcome_strip · offset_ok · PPFD 200 · slot_residual none · `/fleet/computed` HTTP 200. Hashes supersede `JuWgMbJV` / `BNJCw6ba` / `DFrH_SAo` from tip `94705f0`.
