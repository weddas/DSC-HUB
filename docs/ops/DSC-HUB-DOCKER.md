...
**Release:** DSC-HUB 7.0.0 — The Pi Release · tip **`39d7f88`** (7.4 software WiP; surface still **7.3.0**).
...
**Pitfall (tip `39d7f88`):** HubLinkLine Age format + `HelpTip` landed in **source** only. Committed `tune-fleet-IPnSFs3d` still lacks `dsc-help-tip` until the next `npm run build:spa` / deploy without `-SkipSpaBuild`. See [`../brain/HELP-TIP.md`](../brain/HELP-TIP.md).
