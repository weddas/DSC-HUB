...
**Release:** DSC-HUB 7.0.0 — The Pi Release · tip **`8208461`** (7.4 software WiP; surface still **7.3.0**).
...
**Pitfall (tips `39d7f88`/`8208461`):** HubLinkLine Age format + `HelpTip` (Overview Want/Got/Colour included) landed in **source** only. Committed `tune-fleet-IPnSFs3d` / `index-DL1EcjhX` still lack `dsc-help-tip` until the next `npm run build:spa` / deploy without `-SkipSpaBuild`. See [`../brain/HELP-TIP.md`](../brain/HELP-TIP.md).
