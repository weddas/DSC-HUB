...
**Release:** DSC-HUB **7.1.0** brain/SPA · firmware train **7.0.0.0** (Pi island).
...
7. Hub ESP-NOW parked on Pi path; brain polls hub demand switches and drives Sonoff relays (45s stale OFF).
...
11. Stamp git tag `v7.1.0` after soak (firmware remains `7.0.0.0`).
...
HA custom panel may still show surface **7.2.0** in lab. Product appliance is brain/SPA **7.1.0** + firmware **7.0.0.0** on Pi.
