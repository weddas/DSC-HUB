...
Verified against tip `2d7bfca` (Hub **8.1.0** published; bake provenance `cce5c74`; firmware train still **8.0.0.0**; SoftAP kit bake + real card bins + thin-catalog cannalib). Rule: [`.cursor/rules/dsc-pi-hotpatch.mdc`](../../.cursor/rules/dsc-pi-hotpatch.mdc) · AGENTS Pi hotpatch bullet. Lab host: `dsc@…`, container `dsc-hub-brain`, static `/app/static/`.
