...
**Tip (Post-mega D-C-A-B):** `f029702` · spa-dist **`index-CXq-NptO.js`** · rule [`.cursor/rules/dsc-pi-hotpatch.mdc`](../../.cursor/rules/dsc-pi-hotpatch.mdc)  
...
Tip `f029702` (Post-mega D splits) expects spa-dist **`index-CXq-NptO.js`** (plus `twin-three-BjdbWAdH.js` · `tune-fleet-DYnNNyOJ.js` · `calibrate-qZfij39E.js`). Prior Mega Pass tip `a307dc7` was `index-DlMHgtYz.js`. Prior audit tip `a2f5f08` was `index-D7pAmjOB.js`.
