...
**Tip:** `cf2337d` · spa-dist `index-BoyhWWR_.js` · Firmware `dsc-hub-v4_0.yaml` · SPA Light / Live / `lightSchedule.ts` · Design [twin-sf1000](../superpowers/specs/2026-08-29-twin-sf1000-design.md) · Pass 4 [pass4 design](../superpowers/specs/2026-09-01-live-ux-pass4-twin-integrated-design.md) · [pass4 plan](../superpowers/plans/2026-09-01-live-ux-pass4-twin-integrated.md) · Task 4 [report](../../.superpowers/sdd/pass4-task-4-report.md)
...
## SPA / brain consumers (verified tip `cf2337d`)
...
| Phase B inventory (Task 5) | **DONE_WITH_CONCERNS** (`84a3387..83af94c`) — B6 fail at inventory |
| Phase C debt closeout (Task 6) | **DONE_WITH_CONCERNS** (`083c178` / spa `index-BoyhWWR_.js`) — SV-P1-6 / AirPathMap / GAUGE-P0-1 / zigbee stubs **fixed** |
| `test_live_ux_pass4_twin.py` | Twin + SF1000 on-map guards; Task 6 focused run **17 passed** (with zigbee stub tests) |
| Task 7 gate | **Open** — Pi hotpatch + full-stress prove |
| Optical / physical PWM | **Not claimed** — GPIO5 reserved |

Phase C deferred to Pass 5: Manual Light Hold sticky ON; energy `confirm=false` → 422 (still blocks). Live Wet/Dry MQTT prove remains gate-owned.
...
# Prove: .audit/live-ux-pass4-prove.ps1 (Phase A GREEN; Task 7 extends; optical N/A)
...
- [`../qa/LIVE-UX-PASS4-WALK-2026-09.md`](../qa/LIVE-UX-PASS4-WALK-2026-09.md) — Pass 4 walk (Phase A/B/C filled; Task 7 gate pending)  
