...
**Tip:** `83af94c` · spa-dist `index-BEjnawnp.js` · Firmware `dsc-hub-v4_0.yaml` · SPA Light / Live / `lightSchedule.ts` · Design [twin-sf1000](../superpowers/specs/2026-08-29-twin-sf1000-design.md) · Pass 4 [pass4 design](../superpowers/specs/2026-09-01-live-ux-pass4-twin-integrated-design.md) · [pass4 plan](../superpowers/plans/2026-09-01-live-ux-pass4-twin-integrated.md) · Task 4 [report](../../.superpowers/sdd/pass4-task-4-report.md)
...
## SPA / brain consumers (verified tip `83af94c`)
...
| Phase B inventory (Task 5) | **DONE_WITH_CONCERNS** (`84a3387..83af94c`) — B6 fail; named parks open |
| Phase C / Task 7 gate | **Open** |
...
- [`../qa/LIVE-UX-PASS4-WALK-2026-09.md`](../qa/LIVE-UX-PASS4-WALK-2026-09.md) — Pass 4 walk (Phase A pass; Phase B filled — B6 fail)  
