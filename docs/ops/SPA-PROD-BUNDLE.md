...
Verified against tip `cce5c74` (Hub **8.1.0**; lazy Twin + `vendor-react` / `twin-three` chunk split still required). Code: `frontend/vite.config.ts`, `frontend/src/App.tsx` (default `surfaceVersion` **8.1.0**).
