...
- Park off-scope findings in `docs/FOLLOWUPS.md` rather than derailing the current pass.
...
- Domain model is probe · plant · assignment: `assigned_plant_id` (roster | None) is separate from `idle_home` (Soil Test dock).
