...
| SPA | `components/journal/*`, `components/energy/LightEnergyPanel.tsx`, Settings Brain `SpaceEnergySettingsCard`; Pass 1 desk CTAs in `LightPage.tsx` (DLI CTA both tents, Climate Want →) |
| Client | `fleetApi.ts` journal/energy helpers |
| Pass 1 honesty | `brain/tests/test_live_ux_light_honesty.py` + [`docs/brain/LIVE-UX-HONESTY.md`](../../docs/brain/LIVE-UX-HONESTY.md) |
