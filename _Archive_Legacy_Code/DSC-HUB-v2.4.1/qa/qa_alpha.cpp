...
// v2.4.1 NOTE: superseded by qa_rig_v241.cpp (nine suites, 24.3M
// checks, extracts run_climate_logic + both photoperiods verbatim
// from dsc-hub-v2_4_1.yaml). Kept for reference.
#include <cstdio>
#include <cstdint>
#include <cmath>
#include <string>
