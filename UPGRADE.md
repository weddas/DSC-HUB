...
(`2d7bfca` — README points at published [`v8.1.0`](https://github.com/weddas/DSC-HUB/releases/tag/v8.1.0);
bake provenance `cce5c74`). See [Kit update honesty](#kit-update-honesty).
...
2. **Check for updates.** GitHub [`v8.1.0`](https://github.com/weddas/DSC-HUB/releases/tag/v8.1.0)
   ...
   Kits already on **8.1.0** correctly see no bump (same numeric core).
3. Offline / no Ethernet: pull tip `2d7bfca` via workstation deploy or
