...
### 7.4 software WiP (`e66f136` — not tagged)

- **Demo mode** — `DSC_DEMO_MODE` software simulation + `docker-compose.demo.yml` (host `:8788`); fail-closed LAN/API-key scrub; [`docs/brain/DEMO-MODE.md`](docs/brain/DEMO-MODE.md).
...
- **SPA** — `index-DRfGbdor` (+ tune-fleet / calibrate / twin-three / AirflowParticleScene).
