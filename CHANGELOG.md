...
### Tip `6a89efa` — pot2 dry-EC honesty (2026-09-08)

- **QA:** pot2 `ec_us 0.0` pre-watering is expected dry-medium physics (no dissolved salts
  in solution), not a fault. Watering differential vs pot1 is the natural probe test.
  Documented in [`docs/qa/TEST-PASS-8.1.0-2026-09-08.md`](docs/qa/TEST-PASS-8.1.0-2026-09-08.md)
  and runbook [`docs/ops/SOFT-CAL.md`](docs/ops/SOFT-CAL.md).
