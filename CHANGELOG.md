...
- **Build a Plant typeahead (`afda0ac`)** — Map singular UI search kinds → plural catalog index keys; ASCII labels (no mojibake); keyboard dropdowns; skip hass re-render while search focused. Ops: `docs/qa/LIVE-UI-BUILD-A-PLANT-TYPEAHEAD.md`.
