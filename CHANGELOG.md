...
- **Docs: Phase B brain ops** — Developer runbook [`docs/qa/DSC-BRAIN-PHASE-B.md`](docs/qa/DSC-BRAIN-PHASE-B.md) (catalog load map, Want precedence, live vs planned API, CLI pitfalls). Aligns `docs/brain/DECISION_LOOP.md` + `WEBUI.md` with verified `brain/dsc_brain/` behavior.
