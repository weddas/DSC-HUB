...
| [`docs/brain/ZIGBEE-ROLE-TASK.md`](docs/brain/ZIGBEE-ROLE-TASK.md) | Settings Zigbee Role vs Task + liquid OOS (tip `e126f654`) |
| [`docs/brain/ROOT-STEERING.md`](docs/brain/ROOT-STEERING.md) | Bar 3 P0–P3 root steering SoT |
