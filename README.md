...
**Live train (in tree):** HA surface **5.1.8** · pots **5.1.7** · Control **5.1.16** · hub **5.1.8** · Sync **5.1.3**  
...
| [`docs/qa/HUB-RF-REJOIN-LINK-BOUNCE.md`](docs/qa/HUB-RF-REJOIN-LINK-BOUNCE.md) | Hub REJOIN → `link_wifi_bounce` (no WiFi `reset()`) |
