...
| | |
|---|---|
| **Release** | [8.1.0](https://github.com/weddas/DSC-HUB/releases/tag/v8.1.0) (tip `6f1b1fa`; bake provenance `cce5c74`) |
...
[`UPGRADE.md`](UPGRADE.md); tip `6f1b1fa` expects fleet train **8.1.0.0** (OTA
