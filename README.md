...
- **ETH01 bridge** — SoftAP fleet home (`DSC-Anchor` + NAPT) + Sonoff drive without HA (F-010); pots stay ESP-NOW star; HA followers stay fallback. Ops: [`docs/qa/SOFTAP-FLEET-HOME.md`](docs/qa/SOFTAP-FLEET-HOME.md).
