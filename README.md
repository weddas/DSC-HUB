...
| | |
|---|---|
| **Release** | [8.1.0](https://github.com/weddas/DSC-HUB/releases/tag/v8.1.0) (tip `6a89efa`; aligned-card bake `89ddfa7`) |
...
[`UPGRADE.md`](UPGRADE.md); tip `6a89efa` (aligned-card `89ddfa7`) expects fleet train **8.1.0.0** (OTA
