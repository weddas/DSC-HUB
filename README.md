...
| [`docs/qa/HUB-ESPNOW-TX-CADENCE-5.1.9.md`](docs/qa/HUB-ESPNOW-TX-CADENCE-5.1.9.md) | Hub 5.1.9 ESP-NOW TX cadence / OOM (N-037) |
...
|---|---|---|
| Hub | `dsc-hub.yaml` → `dsc-hub-v4_0.yaml` + fleet-heal | **5.1.9** |
