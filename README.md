...
| [`docs/qa/PI-APPLIANCE-7.0.md`](docs/qa/PI-APPLIANCE-7.0.md) | **Pi product 7.0** — FleetSnapshot SPA, `useEntityBus`, hub controls/sensors/binaries, `/control`/`/history`, prebuilt deploy, noise_psk, AP |
