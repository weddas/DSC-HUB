...
| [`docs/qa/LIVE-UI-KIT-PULSE.md`](docs/qa/LIVE-UI-KIT-PULSE.md) | Kit Pulse · Twin orbit · Crop Scheduler · Climate triad |
| [`docs/qa/LIVE-UI-CUSTOM-PANEL.md`](docs/qa/LIVE-UI-CUSTOM-PANEL.md) | Custom panel build + surface string drift |
