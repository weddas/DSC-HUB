...
$remote = "sed -i 's/`r$//' /tmp/flash-sonoff-fallback-remote.sh; bash /tmp/flash-sonoff-fallback-remote.sh $PiPassword '$Seats' $ApWaitSeconds"
...
Write-Host "Done. Verify fleet: curl http://10.42.0.1:8787/fleet"
