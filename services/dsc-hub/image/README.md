...
| 8.1.0 aligned-card | **`89ddfa7`** | **4 820 089** | Rebake: kit **8.1.0.0** / ESPHome **2026.8.2**, cannalib, eight non-zero bins |
...
tip `6f1b1fa` — source train **8.1.0.0** + device-builder preference; tip **`89ddfa7`** —
