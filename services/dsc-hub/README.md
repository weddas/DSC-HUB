# DSC-HUB 7.1.1 — Pi appliance (Docker Compose)

Raspberry Pi 4 product stack: brain + SPA (`:8787`), optional local CannaLib fallback (`:8790`), Mosquitto, Zigbee2MQTT (SkyConnect), ESPHome dashboard (`:6052`). Firmware train remains **7.0.0.0**. ETH01 bridge is retired — Sonoff path is the brain appliance driver ([`docs/ops/SONOFF-FLASH.md`](../../docs/ops/SONOFF-FLASH.md) · [`docs/brain/FLEET-INGEST.md`](../../docs/brain/FLEET-INGEST.md)).
